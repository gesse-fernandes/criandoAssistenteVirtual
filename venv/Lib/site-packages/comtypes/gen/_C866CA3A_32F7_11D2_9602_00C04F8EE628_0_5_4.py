...
__all__ = [
    'SPVPRIORITY', 'DISPID_SVEPhoneme',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SVSPhonemeId', 'SPEI_MAX_TTS', 'SpeechRunState',
    'SPXMLRESULTOPTIONS', 'DISPID_SpeechMemoryStream',
    'SSSPTRelativeToEnd', 'ISpeechAudioBufferInfo',
    'DISPID_SVEventInterests', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SSTTTextBuffer',
    'SREPhraseStart', 'SpeechRecoEvents', 'DISPID_SLPLangId',
    'SPXRO_Alternates_SML', 'SREHypothesis', 'SPSERIALIZEDRESULT',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SVEEnginePrivate',
    'ISpeechAudioStatus', 'SPAO_RETAIN_AUDIO', 'SAFT44kHz8BitMono',
    'SpeechCategoryAudioOut', 'DISPID_SPPEngineConfidence',
    'SpObjectTokenCategory', 'DISPID_SVDisplayUI',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SPPId',
    'DISPID_SPPs_NewEnum', 'SGLexicalNoSpecialChars',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpeechPhraseRules',
    'DISPID_SVSLastBookmark', 'DISPID_SpeechPhraseAlternates',
    'SP_VISEME_20', 'SAFTText', 'DISPID_SPARecoResult',
    'SVSFlagsAsync', 'SPCT_SUB_DICTATION', 'ISpStreamFormat',
    'SPPHRASEREPLACEMENT', 'SpeechAllElements', 'SINoise',
    'SpeechAudioFormatGUIDText', 'DISPID_SRRSaveToMemory',
    'SpeechTokenValueCLSID', 'ISpObjectWithToken',
    'SPWT_PRONUNCIATION', 'SpeechVoiceCategoryTTSRate',
    'SpeechVoicePriority', 'DISPID_SFSClose', 'SPCS_ENABLED',
    'SPPHRASEELEMENT', 'ISpeechGrammarRuleStateTransitions',
    'SAFTCCITT_uLaw_44kHzMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SpeechObjectTokens', 'IEnumSpObjectTokens', 'SRESoundEnd',
    'SPEI_TTS_BOOKMARK', 'DISPID_SPRuleName', 'DISPID_SGRSTNextState',
    'SRCS_Enabled', 'SPPHRASERULE', 'DISPID_SVSpeakStream',
    'SAFTGSM610_44kHzMono', 'ISpeechRecoResultTimes',
    'SPDKL_CurrentUser', 'SAFT8kHz8BitMono', 'SAFT44kHz8BitStereo',
    'SAFTCCITT_ALaw_44kHzStereo', 'SVP_18',
    'ISpPhoneticAlphabetSelection', 'SPEVENT',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPGS_DISABLED',
    'DISPID_SRGIsPronounceable', 'Speech_Max_Word_Length',
    'SPWF_SRENGINE', 'SPBO_AHEAD', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SPIStartTime', 'SAFT8kHz16BitMono',
    'DISPID_SDKGetlongValue', 'SECFDefault',
    'IInternetSecurityMgrSite', 'STCLocalServer', 'SPCT_SUB_COMMAND',
    'ISpeechMMSysAudio', 'DISPID_SpeechObjectToken', 'SRSEDone',
    'DISPID_SpeechLexicon', 'DISPID_SGRSTText', 'SDKLDefaultLocation',
    'SDTLexicalForm', 'DISPID_SRRecognizer', 'DISPID_SRRRecoContext',
    'DISPID_SPRuleConfidence', 'SpWaveFormatEx', 'DISPID_SVEViseme',
    'SPWF_INPUT', 'SPPS_Modifier', 'IInternetSecurityManager',
    'DISPID_SOTCreateInstance', 'SPEI_SR_PRIVATE', 'SGSExclusive',
    'DISPID_SPPNumberOfElements', 'DISPID_SpeechPhraseRule',
    'SPEI_RESERVED5', 'SPDATAKEYLOCATION', 'DISPID_SVResume',
    'SRAONone', 'SPAR_Low', 'eLEXTYPE_PRIVATE20', 'SRSActiveAlways',
    'SPWORDPRONUNCIATIONLIST', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'ISpeechXMLRecoResult', 'ISpeechGrammarRuleStateTransition',
    'SAFT11kHz8BitStereo', 'SPWAVEFORMATTYPE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SPAsItem',
    'DISPID_SMSSetData', 'SVP_20', 'SECLowConfidence',
    'SDTDisplayText', 'ISpEventSource',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechPropertyResponseSpeed', 'DISPID_SGRSAddWordTransition',
    'SRTStandard', 'SPSHT_EMAIL', 'STSF_FlagCreate',
    'DISPID_SVGetVoices', 'DISPID_SGRsItem', 'DISPID_SOTId',
    'DISPID_SpeechRecoResult', 'DISPID_SPEEngineConfidence',
    'SpeechPropertyComplexResponseSpeed', 'SVP_5',
    'SPEI_INTERFERENCE', 'SP_VISEME_11', 'SAFT12kHz8BitMono',
    'DISPID_SRSClsidEngine', 'SGDisplay', 'SpeechBookmarkOptions',
    'DISPID_SLWPronunciations', 'DISPID_SpeechLexiconPronunciation',
    'ISpeechCustomStream', 'SVEPrivate', 'SPPS_SuppressWord',
    'ISpeechGrammarRule', 'DISPID_SDKSetBinaryValue',
    'SAFT22kHz8BitMono', 'DISPID_SVSInputWordLength',
    'DISPID_SpeechGrammarRuleStateTransition', 'SpeechLexiconType',
    'DISPID_SOTDisplayUI', 'SAFT48kHz16BitStereo', 'SPRULESTATE',
    'DISPID_SVAudioOutput', 'DISPID_SLGenerationId',
    'SpeechAudioState', 'DISPID_SRCESoundEnd', 'ISpProperties',
    'SPEI_ADAPTATION', 'SPAUDIOBUFFERINFO', 'SVEAllEvents',
    'ISpLexicon', 'SVP_15', 'SVP_0', 'SpeechCategoryAppLexicons',
    'SRAImport', 'SRERecoOtherContext', 'SPEI_SOUND_END',
    'SVSFPurgeBeforeSpeak', 'DISPID_SRRSpeakAudio',
    'DISPID_SpeechRecoContextEvents', 'SPWT_DISPLAY',
    'DISPID_SGRAttributes', 'DISPID_SVVoice', 'SDTAlternates',
    'SPWORDLIST', 'SSFMOpenReadWrite',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SpeechPhraseProperties',
    'DISPID_SLGetPronunciations', 'SpPhoneConverter',
    'SpeechPropertyAdaptationOn', 'eLEXTYPE_PRIVATE1', 'SVPAlert',
    'SGRSTTWildcard', 'DISPID_SPISaveToMemory', 'SPEI_WORD_BOUNDARY',
    'SVP_19', 'SPPS_NotOverriden', 'ISpeechGrammarRules',
    'SAFTCCITT_ALaw_11kHzStereo', 'ISpeechBaseStream',
    'DISPID_SGRSAddSpecialTransition', 'SAFTCCITT_ALaw_8kHzStereo',
    'SRSInactiveWithPurge', 'DISPID_SRSAudioStatus',
    'DISPID_SpeechPhraseElements', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SVVolume', 'DISPID_SpeechPhraseBuilder',
    'ISpeechRecognizer', 'ISpShortcut', 'SVEStartInputStream',
    'DISPID_SRCState', 'DISPID_SGRsCommit',
    'DISPID_SDKGetStringValue', 'SPRULE',
    'DISPID_SPPBRestorePhraseFromMemory', 'SVSFPersistXML',
    'ISpeechPhraseAlternate', 'SP_VISEME_8',
    'DISPID_SRGetRecognizers', 'SPSSuppressWord', 'SPRECOSTATE',
    'SpVoice', 'SP_VISEME_4', 'DISPID_SAFGuid', 'SFTInput',
    'SVPNormal', 'DISPID_SGRClear', 'DISPID_SpeechAudioStatus',
    'DISPID_SRCEPropertyStringChange', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRRGetXMLErrorInfo', 'eWORDTYPE_ADDED',
    'SpeechDataKeyLocation', 'DISPID_SLPsCount', 'SLTApp',
    ...
    'SVSFNLPSpeakPunc', 'SPEI_VISEME', 'SECFIgnoreCase',
    'ISpeechRecognizerStatus', 'DISPID_SOTCSetId',
    'DISPID_SLPSymbolic', 'DISPID_SPRuleChildren',
    'DISPID_SOTCGetDataKey', 'SAFT16kHz8BitStereo',
    'eLEXTYPE_USER_SHORTCUT', 'SPINTERFERENCE_TOOFAST', 'SVP_2',
    'SpeechAudioFormatType', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SVSRunningState', 'DISPID_SRCERecognition',
    'DISPID_SPPParent', 'ISpRecoCategory',
    'SpeechRecoProfileProperties', 'DISPID_SPRuleParent',
    'DISPID_SPEPronunciation', 'eLEXTYPE_PRIVATE12', 'SPGS_ENABLED',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechWordType', 'SPVPRI_ALERT',
    'DISPID_SRIsShared', 'SVSFParseSapi', 'eLEXTYPE_VENDORLEXICON',
    'SAFT12kHz16BitMono', 'SPSLMA', 'SVF_Stressed',
    'SAFT32kHz8BitMono', 'SPEI_PHRASE_START', 'tagSTATSTG',
    'DISPID_SRRTLength', 'SRSInactive', 'SDTRule', 'DISPID_SOTsItem',
    'STSF_AppData', 'SDKLLocalMachine',
    'DISPID_SLRemovePronunciation', 'SVSFParseSsml',
    'SPSNotOverriden', 'DISPID_SLWType',
    'DISPID_SOTMatchesAttributes', 'ISequentialStream',
    'DISPID_SAEventHandle', 'DISPID_SPEDisplayAttributes',
    'SpeechVoiceEvents', 'SVSFUnusedFlags',
    'DISPID_SGRSTPropertyValue', 'DISPID_SABIBufferSize',
    'DISPID_SVEAudioLevel', 'DISPID_SRCRetainedAudioFormat',
    'SP_VISEME_3', 'IStream', 'DISPID_SDKDeleteValue', 'SP_VISEME_15',
    '_ISpeechVoiceEvents', 'SPAUDIOSTATE', 'SpeechPartOfSpeech',
    'SPSMF_UPS', 'SRTReSent', 'SPPS_RESERVED4',
    'SPDKL_DefaultLocation', 'DISPID_SpeechVoiceEvent',
    'SVF_Emphasis', 'DISPID_SOTCategory', 'ISpRecognizer3',
    'DISPID_SRGetPropertyNumber', 'SPEI_MIN_SR', 'eLEXTYPE_RESERVED4',
    'SINoSignal', 'SDA_Two_Trailing_Spaces', 'SpNullPhoneConverter',
    'DISPID_SVEVoiceChange', 'DISPID_SGRSTWeight',
    'SpeechGrammarTagDictation', 'SVSFIsFilename', 'SPSHORTCUTTYPE',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SP_VISEME_10',
    'SVP_8', 'DISPID_SRGDictationUnload', 'SpeechInterference',
    'DISPID_SGRSTPropertyName', 'SVSFVoiceMask', 'SpeechVisemeType',
    'DISPID_SPACommit', 'SPEI_TTS_AUDIO_LEVEL', 'SDTProperty',
    'SPSMF_SRGS_SAPIPROPERTIES', 'eLEXTYPE_PRIVATE19',
    'DISPID_SOTCDefault', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRRTimes', 'SpStreamFormatConverter',
    'SPEI_FALSE_RECOGNITION', 'ISpNotifySink', 'ISpObjectToken',
    'DISPID_SRGetPropertyString', 'DISPID_SPRs_NewEnum',
    'DISPID_SDKOpenKey', 'ISpeechMemoryStream',
    'DISPID_SpeechRecoResult2', 'SPLOADOPTIONS', 'STCAll',
    'Speech_Max_Pron_Length', 'SGRSTTWord', 'SpeechTokenKeyFiles',
    'DISPID_SVSLastResult', 'SPSHT_OTHER', 'SREStreamEnd',
    'SpInProcRecoContext', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SOTRemoveStorageFileName', 'SPEI_UNDEFINED',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SVGetAudioInputs',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPRulesItem',
    'SPRST_ACTIVE_ALWAYS', 'ISpRecognizer', 'SpUnCompressedLexicon',
    'SAFT12kHz16BitStereo', 'SREFalseRecognition', 'ISpXMLRecoResult',
    'ISpResourceManager', 'SAFT44kHz16BitStereo',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPEAudioTimeOffset',
    'ISpPhoneticAlphabetConverter', 'DISPID_SpeechDataKey',
    'SpeechTokenIdUserLexicon', 'DISPID_SpeechPhraseReplacement',
    'SP_VISEME_17', 'SpeechPropertyResourceUsage',
    'SVSFParseAutodetect', 'SpeechTokenShellFolder',
    'SpeechDiscardType', 'SpCustomStream',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRGCmdLoadFromMemory',
    'SPEI_RESERVED1', 'DISPID_SPRDisplayAttributes',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SAVolume', 'SpAudioFormat',
    'SASRun', 'DISPID_SPIReplacements', 'SpMMAudioIn',
    'DISPID_SPPFirstElement', 'ISpSerializeState',
    'SPEI_START_INPUT_STREAM', 'DISPID_SRGRecoContext',
    ...
    'DISPID_SADefaultFormat', 'SREStreamStart',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SRCERequestUI',
    'DISPID_SPRsItem', 'SVP_12', 'ISpeechAudioFormat',
    'DISPID_SLPsItem', 'SpeechRegistryLocalMachineRoot',
    'SAFT16kHz16BitStereo', 'SVSFDefault',
    'DISPID_SVESentenceBoundary', 'ISpDataKey', 'DISPID_SDKDeleteKey',
    'DISPID_SASState', 'SPBOOKMARKOPTIONS', 'SPPROPERTYINFO',
    'DISPID_SpeechVoice', 'SPRST_ACTIVE', 'DISPID_SGRInitialState',
    'DISPID_SVSInputWordPosition',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechGrammarRuleStateTransitionType', 'eLEXTYPE_RESERVED6',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SWFEBitsPerSample',
    'SpeechUserTraining', 'SPRECOGNIZERSTATUS', 'SPAS_RUN',
    'DISPID_SpeechPhraseAlternate', 'SpeechAudioVolume',
    'SAFT24kHz8BitMono', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SGRsCommitAndSave', 'SPWORDPRONUNCIATION', 'SGDSActive',
    'DISPID_SPPsItem', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SPEActualConfidence', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SLPs_NewEnum', 'eLEXTYPE_PRIVATE6', 'SRESoundStart',
    'DISPID_SWFESamplesPerSec', 'DISPIDSPRG', 'SPAR_Medium',
    'DISPID_SASetState', 'SpeechCategoryVoices', 'SPEI_TTS_PRIVATE',
    'SVESentenceBoundary', 'SPAS_CLOSED', 'SpCompressedLexicon',
    'DISPID_SRCPause', 'DISPID_SVAudioOutputStream',
    'eLEXTYPE_PRIVATE14', 'DISPID_SRCRetainedAudio', 'SRERecognition',
    'DISPID_SRRAlternates', 'SpeechPropertyLowConfidenceThreshold',
    'SPAO_NONE', 'DISPID_SLWsCount', 'SBONone',
    'DISPID_SVSInputSentenceLength', 'SASClosed',
    'DISPID_SDKCreateKey', 'DISPID_SPRText', 'ISpMMSysAudio',
    'DISPID_SpeechXMLRecoResult', 'SRAInterpreter', 'SVP_17',
    'DISPID_SOTSetId', 'ISpeechRecoResultDispatch',
    'ISpPhoneConverter', 'SPEI_REQUEST_UI', 'DISPID_SMSGetData',
    'DISPID_SDKEnumValues', 'ISpeechLexiconPronunciation',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SPPConfidence', 'SP_VISEME_9',
    'DISPID_SVPause', 'SP_VISEME_14', 'SVEWordBoundary',
    'SPINTERFERENCE_NONE', 'SPDKL_CurrentConfig',
    'SpNotifyTranslator', 'SP_VISEME_18', 'SAFT11kHz16BitStereo',
    'SPAUDIOOPTIONS', 'eLEXTYPE_RESERVED9', 'SGDSInactive',
    'DISPID_SVEStreamStart', 'DISPID_SRSCurrentStreamNumber',
    'SpSharedRecoContext', 'DISPID_SABufferInfo', 'SPEI_RESERVED2',
    'SITooLoud', 'SPRS_ACTIVE', 'SREAllEvents', 'SRSActive',
    'ISpeechRecoContext', 'SpeechDictationTopicSpelling',
    'ISpStreamFormatConverter', 'SWTDeleted', 'SPEI_SR_BOOKMARK',
    'SpeechGrammarWordType', 'DISPID_SRGCmdLoadFromResource',
    'SVSFIsXML', 'ISpeechLexicon', 'SPSTREAMFORMATTYPE',
    'SAFT16kHz16BitMono', 'DISPID_SRAudioInputStream',
    'DISPID_SASCurrentDevicePosition', 'SPEVENTSOURCEINFO',
    'SAFT22kHz16BitStereo', 'DISPID_SRCVoice',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SRRPhraseInfo',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SAFGetWaveFormatEx',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SAFType',
    'eLEXTYPE_PRIVATE3', 'SAFT24kHz16BitStereo', 'SPLO_DYNAMIC',
    'SpeechVisemeFeature', 'DISPID_SVIsUISupported', 'SP_VISEME_19',
    'ISpRecoGrammar2', 'SpeechRuleAttributes', 'DISPID_SMSADeviceId',
    'SAFTGSM610_22kHzMono', 'LONG_PTR', 'SAFT24kHz16BitMono',
    'SpeechSpecialTransitionType', 'SVP_9', 'SREPropertyNumChange',
    'DISPID_SCSBaseStream', 'DISPID_SOTGetStorageFileName',
    'SPRECORESULTTIMES', 'SP_VISEME_12', 'DISPIDSPTSI',
    'DISPID_SGRSTsCount', 'IEnumString', 'ISpeechResourceLoader',
    'SPBO_PAUSE', 'SDA_One_Trailing_Space', 'SECFIgnoreKanaType',
    'SpeechGrammarTagWildcard', 'SAFTCCITT_uLaw_22kHzMono', 'SINone',
    'SP_VISEME_2', 'SSTTWildcard', 'SP_VISEME_21', 'SREAudioLevel',
    'SP_VISEME_16', 'SDTReplacement', 'SPEVENTENUM', 'SPBO_NONE',
    'SAFT16kHz8BitMono', 'eLEXTYPE_PRIVATE11', 'ISpeechVoice',
    'SVEEndInputStream', 'ISpGrammarBuilder', 'SAFT8kHz16BitStereo',
    'SVEAudioLevel', 'SVP_10', 'DISPID_SPERetainedSizeBytes',
    'SASStop', 'eWORDTYPE_DELETED', 'ISpeechWaveFormatEx',
    'SAFT11kHz16BitMono', 'SAFTADPCM_8kHzStereo',
    'DISPID_SWFEAvgBytesPerSec', 'SFTSREngine',
    'ISpeechPhraseReplacement', 'SPEI_RECO_OTHER_CONTEXT',
    'SPCT_SLEEP', 'DISPID_SAFSetWaveFormatEx', 'UINT_PTR',
    'DISPID_SGRAddState', 'SAFTGSM610_11kHzMono',
    'SAFT24kHz8BitStereo', 'SVEVoiceChange', 'SPPS_Noncontent',
    'SAFT48kHz8BitStereo', 'SPTEXTSELECTIONINFO', 'DISPID_SVRate',
    'SVSFParseMask', 'SPRST_INACTIVE',
    'DISPID_SpeechPhraseReplacements', 'SPEI_RESERVED6',
    'DISPID_SpeechRecoContext', 'DISPID_SVEStreamEnd',
    'SpeechRecognizerState', 'DISPID_SWFEExtraData',
    'SAFTCCITT_uLaw_8kHzMono', 'SPINTERFERENCE_LATENCY_WARNING',
    'SAFT22kHz8BitStereo', 'DISPID_SpeechRecoResultTimes',
    'SREPrivate', 'SGSDisabled', 'SGPronounciation',
    'DISPID_SGRsCount', 'DISPID_SGRsDynamic', 'tagSPPROPERTYINFO',
    'SECFNoSpecialChars', 'DISPID_SPPValue',
    'ISpeechLexiconPronunciations', 'SPAR_High',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SVSkip',
    'DISPID_SRGCommit', 'eLEXTYPE_PRIVATE8', 'DISPID_SBSFormat',
    'DISPID_SpeechCustomStream', 'DISPID_SGRSTType',
    'DISPID_SPRFirstElement', 'SDTPronunciation', 'eLEXTYPE_PRIVATE7',
    'ISpEventSink', 'ISpeechPhraseProperties', 'SPEI_START_SR_STREAM',
    'DISPID_SVStatus', 'DISPID_SPPChildren', 'DISPID_SMSALineId',
    'SAFT32kHz16BitMono', 'SVP_16', 'DISPID_SpeechGrammarRules',
    'DISPID_SOTCEnumerateTokens', 'SPWORDPRONOUNCEABLE',
    'DISPID_SVAlertBoundary', 'DISPID_SLGetWords', 'DISPID_SGRId',
    'DISPID_SRCEEndStream', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'ISpeechPhraseRule', 'DISPID_SRCEHypothesis',
    'SPSEMANTICERRORINFO', 'DISPID_SPPName', 'DISPID_SRCResume',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPRulesCount',
    'SPRST_NUM_STATES', 'SPDKL_LocalMachine', 'DISPID_SPIElements',
    'DISPID_SpeechRecognizer', 'SREAdaptation', 'DISPID_SBSSeek',
    'DISPID_SPELexicalForm', 'SPCT_DICTATION',
    'SAFTADPCM_44kHzStereo', 'DISPID_SpeechPhraseInfo',
    'SPPHRASEPROPERTY', 'ISpStream', 'SGRSTTEpsilon', 'SSFMCreate',
    'ISpRecoGrammar', 'DISPIDSPTSI_ActiveLength', 'SPPS_LMA',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRCSetAdaptationData',
    'SpObjectToken', 'ISpeechPhoneConverter', 'DISPID_SGRAddResource',
    'SpeechTokenContext', 'SPPS_Interjection', 'SVPOver',
    'SpInprocRecognizer', 'DISPID_SGRSTRule', 'SPFM_OPEN_READWRITE',
    'SPEI_SOUND_START', 'DISPID_SRRTOffsetFromStart',
    'SPPS_RESERVED1', 'SRATopLevel', 'DISPID_SPERequiredConfidence',
    'SVP_14', 'SPFM_CREATE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SASNonBlockingIO', 'DISPID_SOTRemove',
    'ISpNotifyTranslator', 'DISPID_SRCEAudioLevel',
    'SDA_Consume_Leading_Spaces', 'SpStream', 'SPLEXICONTYPE',
    'ISpeechPhraseReplacements', 'SpMemoryStream', 'SDKLCurrentUser',
    'SPEI_END_INPUT_STREAM', 'SPPS_Verb', 'SVP_7',
    'eLEXTYPE_RESERVED7', 'SREInterference', 'SP_VISEME_6',
    'SWPUnknownWordPronounceable', 'eLEXTYPE_PRIVATE4',
    'SGDSActiveUserDelimited', 'SpeechRuleState',
    'eLEXTYPE_RESERVED8', 'SPAS_STOP',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SpeechGrammarRuleState',
    'eLEXTYPE_PRIVATE17', 'SPWORDTYPE',
    'DISPID_SASCurrentSeekPosition', 'SP_VISEME_0',
    'DISPID_SVPriority', 'SDTAll', 'SECFIgnoreWidth', 'SPWT_LEXICAL',
    'SPWORD', 'SREBookmark', 'SPPS_Unknown', 'DISPID_SRRTTickCount',
    ...
    'DISPID_SWFEBlockAlign', 'ISpeechFileStream',
    'Speech_StreamPos_Asap', 'SAFTGSM610_8kHzMono',
    'DISPID_SRGetFormat', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SPEs_NewEnum', 'DISPID_SRGRules', 'DISPID_SPIRule',
    'SDA_No_Trailing_Space', 'SGRSTTDictation', 'DISPID_SGRs_NewEnum',
    'DISPID_SVEWord', 'SPEI_VOICE_CHANGE',
    'DISPID_SRGCmdSetRuleIdState', 'SVF_None',
    'SPSMF_SAPI_PROPERTIES', 'SPCONTEXTSTATE',
    'DISPID_SRCESoundStart', 'SpeechGrammarState',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SLPPhoneIds',
    'eLEXTYPE_LETTERTOSOUND', 'SpeechCategoryAudioIn',
    'ISpeechDataKey', 'SAFT44kHz16BitMono', 'ISpeechPhraseInfo',
    'ISpeechPhraseAlternates', 'SREStateChange',
    'DISPID_SRSetPropertyString', 'DISPID_SRGSetWordSequenceData',
    'SVSFNLPMask', 'SpeechMicTraining', 'SAFTCCITT_ALaw_22kHzMono',
    'SAFTCCITT_ALaw_44kHzMono', 'SPPHRASE', 'SPEI_END_SR_STREAM',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SWFEFormatTag',
    'SGSEnabled', 'SLODynamic', 'ISpeechAudio',
    'DISPID_SPRuleFirstElement', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SRSetPropertyNumber', 'SPPS_Function', 'SBOPause',
    'SPRECOCONTEXTSTATUS', 'SRAORetainAudio',
    'DISPID_SpeechPhraseProperty', 'SRARoot', 'SP_VISEME_1',
    'SPEI_SR_AUDIO_LEVEL', 'SPEI_RECO_STATE_CHANGE',
    'SAFT12kHz8BitStereo', 'DISPID_SRRAudio', 'SPVPRI_OVER',
    'DISPID_SRGDictationSetState', 'ISpeechPhraseInfoBuilder',
    'DISPID_SpeechLexiconWord', 'DISPID_SRCEInterference',
    'DISPID_SPAsCount', 'eLEXTYPE_PRIVATE16', 'DISPID_SRCEAdaptation',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPGRAMMARWORDTYPE',
    'SpeechRecognitionType', 'SpeechCategoryRecoProfiles',
    'DISPID_SLAddPronunciation', 'DISPID_SVGetProfiles',
    'DISPID_SOTGetAttribute', 'SPEI_HYPOTHESIS', 'SPAS_PAUSE',
    'ISpeechRecoResult2', 'DISPID_SPEsItem', 'SPSNoun',
    'ISpRecognizer2', 'DISPID_SVEBookmark', 'DISPID_SLPType',
    'SpeechRecoContextState', 'SPSEMANTICFORMAT', 'DISPID_SRStatus',
    'DISPID_SRSCurrentStreamPosition', 'SpeechAudioProperties',
    'STCInprocHandler', 'SVP_21', 'eLEXTYPE_PRIVATE15',
    'SpTextSelectionInformation', 'SpeechCategoryPhoneConverters',
    'ISpNotifySource', 'SSSPTRelativeToStart', 'DISPID_SRAudioInput',
    'SPAUDIOSTATUS', 'ISpeechTextSelectionInformation',
    'Speech_Default_Weight', 'DISPID_SPILanguageId',
    'ISpeechVoiceStatus', 'SPSInterjection', 'eLEXTYPE_PRIVATE13',
    'SGLexical', 'SVP_11', 'SPINTERFERENCE', 'SPSHORTCUTPAIR',
    'SVEPhoneme', 'SWPUnknownWordUnpronounceable', 'STCRemoteServer',
    'DISPID_SPIAudioStreamPosition', 'SpShortcut',
    'SpeechAudioFormatGUIDWave', 'SITooQuiet', 'SPSUnknown',
    'SPEI_RESERVED3', 'DISPID_SpeechLexiconWords',
    'DISPID_SpeechBaseStream', 'ISpeechObjectTokenCategory',
    ...
    'SPSHORTCUTPAIRLIST', 'SPSHT_Unknown', 'SVP_13',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechWaveFormatEx',
    'SPCATEGORYTYPE', 'DISPID_SRDisplayUI', 'DISPID_SLWsItem',
    '_RemotableHandle', 'DISPID_SGRsFindRule', 'SAFTADPCM_11kHzMono',
    'SpMMAudioEnum', 'SECFEmulateResult', 'SPXRO_SML',
    'SGDSActiveWithAutoPause', 'DISPID_SPIGetDisplayAttributes',
    'SPRST_INACTIVE_WITH_PURGE', 'SWPKnownWordPronounceable',
    'eLEXTYPE_PRIVATE2', 'DISPID_SVSpeak', 'SP_VISEME_7',
    'SPPS_RESERVED2', 'DISPID_SPEAudioSizeTime',
    'ISpeechPhraseElements', 'DISPID_SPIEnginePrivateData',
    'SpeechRegistryUserRoot', 'SPLO_STATIC',
    'DISPID_SPAStartElementInResult', 'DISPID_SLWWord',
    'DISPID_SOTDataKey', 'SpeechEngineConfidence',
    'DISPID_SDKEnumKeys', 'SVP_3', 'DISPID_SRGId',
    'DISPID_SRGDictationLoad', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SAFTDefault', 'SDTAudio', 'DISPID_SRCEStartStream',
    'DISPID_SpeechPhoneConverter', 'ISpPhrase', 'SAFT11kHz8BitMono',
    'SpeechStreamSeekPositionType', 'SVEViseme',
    'DISPID_SRCCmdMaxAlternates', 'SpeechFormatType',
    'DISPID_SBSWrite', 'SpeechVoiceSpeakFlags', 'SP_VISEME_5',
    'ISpeechObjectTokens', 'SPVOICESTATUS', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SpeechMMSysAudio', 'SLOStatic',
    'DISPID_SVSInputSentencePosition', 'SRAExport', 'SRSEIsSpeaking',
    'DISPID_SPPsCount', 'DISPID_SRCCreateGrammar',
    'ISpeechRecoResult', 'DISPID_SGRSTPropertyId',
    'SpeechCategoryRecognizers', 'SpeechEngineProperties',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SLGetGenerationChange', 'SPVPRI_NORMAL', 'SASPause',
    'DISPID_SPEAudioStreamOffset', 'SPEI_MAX_SR',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRProfile', 'SITooSlow',
    'ISpeechLexiconWord', 'DISPID_SpeechAudio', 'eLEXTYPE_USER',
    'eLEXTYPE_RESERVED10', 'SpMMAudioOut',
    'DISPID_SRGCmdSetRuleState', 'SpPhraseInfoBuilder',
    'STSF_CommonAppData', 'SpResourceManager', 'SpeechLoadOption',
    'DISPID_SWFEChannels', 'ISpVoice', 'SpeechAddRemoveWord',
    'WAVEFORMATEX', 'SVSFIsNotXML', 'DISPID_SBSRead',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRSSupportedLanguages',
    'SRADynamic', 'DISPID_SVSyncronousSpeakTimeout', 'SPPS_RESERVED3',
    'DISPID_SFSOpen', 'DISPID_SPIProperties', 'SPGS_EXCLUSIVE',
    'ISpPhraseAlt', 'DISPID_SGRSTsItem', 'SPSModifier',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRCEFalseRecognition',
    'SPEI_SENTENCE_BOUNDARY', 'SPFM_OPEN_READONLY',
    'SAFTNonStandardFormat', 'SP_VISEME_13', 'SPFM_CREATE_ALWAYS',
    'eLEXTYPE_PRIVATE9', 'DISPID_SRIsUISupported',
    ...
    'SAFT22kHz16BitMono', 'DISPID_SPIGetText',
    'SpeechTokenKeyAttributes', 'SPFM_NUM_MODES', 'SRTSMLTimeout',
    'SAFTADPCM_8kHzMono', 'SSFMOpenForRead', 'SRADefaultToActive',
    'SPVISEMES', 'STSF_LocalAppData', 'DISPID_SLWs_NewEnum',
    'ISpeechLexiconWords', 'SpeechStreamFileMode',
    'DISPID_SPRules_NewEnum', 'eLEXTYPE_MORPHOLOGY',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SpeechPhraseRules',
    'ISpeechPhraseElement', 'DISPID_SGRSTransitions',
    'SAFTNoAssignedFormat', 'SPCS_DISABLED', 'SPGRAMMARSTATE',
    '_SPAUDIOSTATE', 'SPBINARYGRAMMAR', 'DISPID_SRGState',
    'DISPID_SGRsAdd', 'DISPID_SRCRequestedUIType', 'ISpRecoResult',
    'SpeechDisplayAttributes', 'SRTEmulated',
    'DISPID_SOTIsUISupported', 'DISPID_SPEsCount', 'SpFileStream',
    'SpeechWordPronounceable', 'DISPID_SpeechPhraseElement',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', '__MIDL_IWinTypes_0009',
    'SpSharedRecognizer', 'eLEXTYPE_APP',
    'DISPID_SPIRetainedSizeBytes', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SPEAudioSizeBytes', 'SSFMCreateForWrite',
    'DISPID_SPIGrammarId', 'DISPID_SGRSRule',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SMSAMMHandle',
    'DISPID_SRRTStreamTime', 'SAFT8kHz8BitStereo', 'DISPID_SRGReset',
    'SAFTADPCM_22kHzMono', 'SPEI_RECOGNITION', 'SPEI_PHONEME',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SOTsCount', 'SRTAutopause',
    'DISPID_SpeechLexiconProns',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SPRuleEngineConfidence', 'SVEBookmark',
    'eLEXTYPE_PRIVATE18', 'ISpRecoContext2', 'SECHighConfidence',
    'DISPID_SPEDisplayText', 'SWTAdded', 'SRERequestUI',
    'DISPID_SOTGetDescription', 'SPSERIALIZEDPHRASE', 'DISPID_SOTCId',
    'SDKLCurrentConfig', 'SPPS_Noun', 'ISpRecoContext',
    'SSTTDictation', 'SAFT32kHz8BitStereo', 'DISPID_SRCEBookmark',
    'SAFT48kHz8BitMono', 'SPPARTOFSPEECH',
    'DISPID_SABufferNotifySize', 'SPCT_COMMAND',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SVWaitUntilDone',
    'SpeechEmulationCompareFlags', 'ISpeechObjectToken',
    'DISPID_SPCIdToPhone', 'DISPID_SRGSetTextSelection',
    'SRCS_Disabled', 'DISPID_SpeechRecognizerStatus',
    'SpeechPropertyHighConfidenceThreshold', 'SRTExtendableParse',
    'DISPID_SASFreeBufferSpace', 'SPSVerb', 'SITooFast',
    'ISpeechRecoGrammar', 'DISPID_SPAs_NewEnum',
    'DISPID_SLPPartOfSpeech', 'DISPID_SPRuleId',
    'ISpeechPhraseProperty', 'SAFTExtendedAudioFormat', 'SVP_6',
    'STCInprocServer', 'Speech_StreamPos_RealTime', 'SPEI_MIN_TTS',
    'ISpAudio', 'ISpObjectTokenCategory', 'SPINTERFERENCE_NOISE',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SDKSetLongValue',
    'SAFTADPCM_22kHzStereo', 'SAFT48kHz16BitMono',
    'SAFTADPCM_44kHzMono', 'SVP_1', 'DISPID_SPRsCount',
    'DISPID_SABIEventBias', 'DISPID_SAStatus', 'eLEXTYPE_PRIVATE10',
    'SREPropertyStringChange', 'SGRSTTRule', 'DISPID_SPCLangId',
    'SPSFunction', 'SPBO_TIME_UNITS', 'SPAR_Unknown',
    'DISPID_SOTs_NewEnum', '_ISpeechRecoContextEvents', 'SVP_4',
    'SpeechTokenKeyUI', 'DISPID_SDKSetStringValue',
    'DISPID_SPCPhoneToId', 'DISPID_SRState', 'DISPID_SLWLangId',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SPIAudioSizeTime',
    'DISPID_SGRName', 'DISPID_SVSLastBookmarkId', 'SPFILEMODE',
    'SLTUser', 'DISPID_SpeechFileStream', 'SPRS_INACTIVE',
    'DISPID_SRCreateRecoContext'
]

_check_version('1.1.14', 1662606460.267754)
